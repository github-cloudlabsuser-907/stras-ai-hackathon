...
class AzureBlobStorageClient:
    def __init__(self, account_name: str = None, account_key: str = None, container_name: str = None):
        ...
        try:
            _ = self.blob_service_client.create_container(name=self.container_name)
    ...
    def upload_file(self, bytes_data, file_name, content_type):
    ...
    def get_all_files(self):
        ...
        for file in files:
            converted_filename = file.pop('converted_filename', '').replace('%20', ' ')
    ...
    def download_blob(self, file_name):
        return self.blob_service_client.get_blob_client(
            container=self.container_name, blob=file_name
        ).download_blob().content_as_bytes()
