...
default_languages = {"translation": {"af": {"name": "Afrikaans", "nativeName": "Afrikaans", "dir": "ltr"},
                                     ...
                                     "dsb": {"name": "Lower Sorbian", "nativeName": "Dolnoserbšćina", "dir": "ltr"},
                                     ...
                                     "gom": {"name": "Konkani", "nativeName": "Konkani", "dir": "ltr"},
                                     ...
                                     "lug": {"name": "Ganda", "nativeName": "Ganda", "dir": "ltr"},
                                     ...
                                     "mn-Cyrl": {"name": "Mongolian (Cyrillic)", "nativeName": "Mongolian (Cyrillic)",
                                                 "dir": "ltr"},
                                     "mn-Mong": {"name": "Mongolian (Traditional)", "nativeName": "ᠮᠣᠩᠭᠣᠯ ᠬᠡᠯᠡ",
                                                 "dir": "ltr"},
                                     ...
                                     "run": {"name": "Rundi", "nativeName": "Rundi", "dir": "ltr"},
                                     "rw": {"name": "Kinyarwanda", "nativeName": "Kinyarwanda", "dir": "ltr"},
                                     ...
                                     "sr-Cyrl": {"name": "Serbian (Cyrillic)", "nativeName": "Српски (ћирилица)",
                                                 "dir": "ltr"},
                                     "sr-Latn": {"name": "Serbian (Latin)", "nativeName": "Srpski (latinica)",
                                                 "dir": "ltr"},
                                     "st": {"name": "Sesotho", "nativeName": "Sesotho", "dir": "ltr"},
                                     ...
                                     "tlh-Latn": {"name": "Klingon (Latin)", "nativeName": "Klingon (Latin)",
                                                  "dir": "ltr"},
                                     "tlh-Piqd": {"name": "Klingon (pIqaD)", "nativeName": "Klingon (pIqaD)",
                                                  "dir": "ltr"},
                                     "tn": {"name": "Setswana", "nativeName": "Setswana", "dir": "ltr"},
                                     ...
                                     "yue": {"name": "Cantonese (Traditional)", "nativeName": "粵語 (繁體)",
                                             "dir": "ltr"},
                                     "zh-Hans": {"name": "Chinese Simplified", "nativeName": "中文 (简体)",
                                                 "dir": "ltr"},
                                     "zh-Hant": {"name": "Chinese Traditional", "nativeName": "繁體中文 (繁體)",
                                                 "dir": "ltr"},
...
class AzureTranslatorClient:
    def __init__(self, translate_key=None, translate_region=None, translate_endpoint=None):
        ...
        if os.getenv('VNET_DEPLOYMENT', 'false') == 'false':
            self.detect_endpoint = urllib.parse.urljoin(self.translate_endpoint,
                                                        f"/detect?api-version={self.api_version}")
            self.translate_endpoint = urllib.parse.urljoin(self.translate_endpoint,
                                                           f"/translate?api-version={self.api_version}")
        else:
            self.detect_endpoint = urllib.parse.urljoin(self.translate_endpoint,
                                                        f"/translator/text/v3.0/detect?api-version={self.api_version}")
            self.translate_endpoint = urllib.parse.urljoin(self.translate_endpoint,
                                                           f"/translator/text/v3.0/translate?api-version={self.api_version}")
    ...
    def get_available_languages(self):
        if os.getenv('VNET_DEPLOYMENT', 'false') == 'true':
            ...
            r = requests.get(
                f"https://api.cognitive.microsofttranslator.com/languages?api-version={self.api_version}&scope=translation")
